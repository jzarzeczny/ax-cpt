  ...
  if (phase === 0) {
    ...
    return (
      <>
        ...
        <p>
          ...
          <br />
          wcisnąć przycisk 2 tak szybko, jak to możliwe.
          <br />
          <br /> Pamiętaj, że zawsze będziesz naciskać przycisk 1, gdy zobaczysz
          pierwszą literę.
          <br />
          <br />
        ...
        <ul>
          <li>wcisnąć przycisk 1, gdy pojawi się pierwsza litera</li>
          <li>
            nacisnąć przycisk 2, jeśli drugą literą, którą widzisz na ekranie
    ...
    return (
      <>
        ...
        <p>
          - naciśnąć przycisk 1, gdy pojawi się pierwsza litera <br />- naciśnąć
          przycisk 1, jeśli druga litera nie należy do pary A-X
        </p>
      </>
    );
  } else if (phase === 4) {
    ...
    return (
      <>
        ...
        <p>
          ...
          Powinieneś/-aś wcisnąć przycisk 1, gdy pojawi się A, i przycisk 2, gdy
          pojawi się X. <br />
          Próba druga: widzisz B, następuje długa przerwa, widzisz X. Powinieneś
          wcisnąć przycisk 1, gdy pojawi się B, i przycisk 1, gdy pojawi się X.{" "}
          <br />
          Próba trzecia: widzisz A, jest duże opóźnienie, widzisz 6. Powinieneś
          wcisnąć przycisk 1, gdy pojawi się A, i w ogóle nie reagować, gdy
          zobaczysz 6.
        </p>
      </>
    );
    ...
    return (
      <>
        ...
        <p>
          (tzn. naciśniesz przycisk 2, ale nie zobaczyłeś/-aś pary liter "A-X",
          albo przycisk 1, ale zobaczysz parę liter "A-X"), usłyszysz dźwięk
          "brzęczenia".
        </p>
      </>
    );
    ...
    return (
      <>
        <p>
          ...
          (pamiętaj, że nigdy nie powinieneś/-aś naciskać przycisku odpowiedzi,
          gdy drugim bodźcem jest cyfra), usłyszysz dźwięk "dee-dum".
        </p>
      </>
    );
  } else if (phase === 10) {
